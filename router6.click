...
rp1::LossyRouterPort(DEV $dev12, IN_MAC $addrDev12, OUT_MAC $addrDev11, LOSS 0.98, DELAY 0.2);

bc::BasicClassifier();
bs::BasicSwitch(NUMBER_PORT 1);
te::TopoElement(MY_ADDRESS 106, NUMBER_PORT 1);
//re::RoutingElement(MY_ADDRESS 106, TOPO_ELEMENT te, NUMBER_PORT 1);
