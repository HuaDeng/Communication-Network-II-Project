...
rp1::RouterPort(DEV $dev1, IN_MAC $addrDev1, OUT_MAC $addrDev2);
rp2::RouterPort(DEV $dev3, IN_MAC $addrDev3, OUT_MAC $addrDev4);

bc::BasicClassifier();
bs::BasicSwitch(NUMBER_PORT 2);
re::RoutingElement(MY_ADDRESS 102, NUMBER_PORT 2);
te::TopoElement(MY_ADDRESS 102, ROUTING_ELEMENT re, NUMBER_PORT 2);
