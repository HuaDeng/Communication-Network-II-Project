...
rp1::LossyRouterPort(DEV $dev6, IN_MAC $addrDev6, OUT_MAC $addrDev5, LOSS 0.98, DELAY 0.2);
rp2::LossyRouterPort(DEV $dev7, IN_MAC $addrDev7, OUT_MAC $addrDev8, LOSS 0.98, DELAY 0.2);

bc::BasicClassifier();
bs::BasicSwitch(NUMBER_PORT 2);
te::TopoElement(MY_ADDRESS 103, NUMBER_PORT 2);
//re::RoutingElement(MY_ADDRESS 103, TOPO_ELEMENT te, NUMBER_PORT 2);
