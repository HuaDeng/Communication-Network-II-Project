...
rp1::LossyRouterPort(DEV $dev10, IN_MAC $addrDev10, OUT_MAC $addrDev9, LOSS 0.98, DELAY 0.2);
rp2::LossyRouterPort(DEV $dev11, IN_MAC $addrDev11, OUT_MAC $addrDev12, LOSS 0.98, DELAY 0.2);

bc::BasicClassifier();
bs::BasicSwitch(NUMBER_PORT 2);
te::TopoElement(MY_ADDRESS 105, NUMBER_PORT 2);
//re::RoutingElement(MY_ADDRESS 105, TOPO_ELEMENT te, NUMBER_PORT 2);
