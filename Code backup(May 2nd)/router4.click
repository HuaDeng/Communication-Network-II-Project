...
rp1::LossyRouterPort(DEV $dev4, IN_MAC $addrDev4, OUT_MAC $addrDev3, LOSS 0.98, DELAY 0.2);
rp2::LossyRouterPort(DEV $dev8, IN_MAC $addrDev8, OUT_MAC $addrDev7, LOSS 0.98, DELAY 0.2);
rp3::LossyRouterPort(DEV $dev9, IN_MAC $addrDev9, OUT_MAC $addrDev10, LOSS 0.98, DELAY 0.2);

bc::BasicClassifier();
bs::BasicSwitch(NUMBER_PORT 3);
te::TopoElement(MY_ADDRESS 104, NUMBER_PORT 3);
//re::RoutingElement(MY_ADDRESS 104, TOPO_ELEMENT te, NUMBER_PORT 3);
