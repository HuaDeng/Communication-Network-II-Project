...
rp1::LossyRouterPort(DEV $dev2, IN_MAC $addrDev2, OUT_MAC $addrDev1, LOSS 0.98, DELAY 0.2);
rp2::LossyRouterPort(DEV $dev5, IN_MAC $addrDev5, OUT_MAC $addrDev6, LOSS 0.98, DELAY 0.2);

bc::BasicClassifier();
bs::BasicSwitch(NUMBER_PORT 2);
te::TopoElement(MY_ADDRESS 102, NUMBER_PORT 2);
//re::RoutingElement(MY_ADDRESS 102, TOPO_ELEMENT te, NUMBER_PORT 2);
