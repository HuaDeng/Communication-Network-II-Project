...
rp1::RouterPort(DEV $dev4, IN_MAC $addrDev4, OUT_MAC $addrDev3);

bc::BasicClassifier();
bs::BasicSwitch(NUMBER_PORT 1);
re::RoutingElement(MY_ADDRESS 103, NUMBER_PORT 1);
te::TopoElement(MY_ADDRESS 103, ROUTING_ELEMENT re, NUMBER_PORT 1);
